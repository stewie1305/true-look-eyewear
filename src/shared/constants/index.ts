export const API_ENDPOINTS = {
  ...
  SHIPPING: {
    ...
    AUTOCOMPLETE: "/shipping/address/autocomplete",
    AHAMOVE_FEE: "/shipping/ahamove/estimate-fee",
    AHAMOVE_CHECKOUT: "/shipping/ahamove/checkout",
    AHAMOVE_ORDERS: "/shipping/ahamove/orders",
    AHAMOVE_CANCEL: "/shipping/ahamove/cancel-order",
  },
  USER_ROLES: {
    BASE: "/user-roles",
...
export const QUERY_KEYS = {
  ...
  SHIPPING: {
    ...
    AHAMOVE_FEE: (payload: any) => ["shipping", "ahamove-fee", JSON.stringify(payload)],
    AHAMOVE_ORDERS: ["shipping", "ahamove-orders"],
    ...
    AUTOCOMPLETE: (text: string) => ["shipping", "autocomplete", text],
  },
